...
flowchart LR
    ...
    subgraph Phase4[Phase 4: polish]
        ...
        r15 --> r13[RFD 13<br>FDB schema — linear-scaling key layout<br>8h]
...
gantt
    ...
    RFD 16 — World output (Elixir DSL) :r16, after r7, 0.5d
    RFD 15 — Web client           :crit, r15, after r14, 2d

    section Phase 4 — Polish
    RFD 4 — World design          :r4, after r15, 1d
    RFD 13 — FDB schema — linear-scaling key layout :r13, after r15, 1d
